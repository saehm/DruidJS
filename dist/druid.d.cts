 ...
 * // [[x1, y1], [x2, y2], [x3, y3]]
 */
declare class PaCMAP<T extends InputType> extends DR<T, ParametersPaCMAP> {
    /**
     * @template {InputType} T
     * @param {T} X
     ...
     */
    constructor(X: T, parameters?: Partial<ParametersPaCMAP>);
    _iter: number;
    /**
     ...
     */
    protected _sample_mn_pairs(nn_sets: Set<number>[], n_MN: number): Int32Array;
    /**
     ...
     * @returns {Int32Array} Flat array of [i, j] pairs
     */
    protected _sample_fp_pairs(nn_sets: Set<number>[], n_FP: number): Int32Array;
    /**
 ...
 * // [[x1, y1], [x2, y2], [x3, y3]]
 */
declare class LocalMAP<T extends InputType> extends PaCMAP<T> {
    /**
     * @template {InputType} T
     * @param {T} X
    ...
    _nn_sets_cache: Set<number>[] | undefined;
}
...
//# sourceMappingURL=druid.d.cts.map
