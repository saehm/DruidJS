[@saehrimnir/druidjs](../globals.md) / SMACOF

# Class: SMACOF\<T\>

Defined in: [dimred/SMACOF.js:21](https://github.com/saehm/DruidJS/blob/dcefb767556f3c4cf43bdeb36d2750ae8d5ef93c/src/dimred/SMACOF.js#L21)
...
[MDS](MDS.md) for the classical approach.
...
> **new SMACOF**\<`T`\>(`X`, `parameters?`): `SMACOF`\<`T`\>

Defined in: [dimred/SMACOF.js:28](https://github.com/saehm/DruidJS/blob/dcefb767556f3c4cf43bdeb36d2750ae8d5ef93c/src/dimred/SMACOF.js#L28)
...
The high-dimensional data or precomputed distance matrix.

##### parameters?

`Partial`\<[`ParametersSMACOF`](../interfaces/ParametersSMACOF.md)\> = `{}`

Object containing parameterization.
...
> **\_parameters**: [`ParametersSMACOF`](../interfaces/ParametersSMACOF.md)
...
> **check\_init**(): `DR`\<`T`, [`ParametersSMACOF`](../interfaces/ParametersSMACOF.md)\>
...
`DR`\<`T`, [`ParametersSMACOF`](../interfaces/ParametersSMACOF.md)\>
...
Defined in: [dimred/SMACOF.js:35](https://github.com/saehm/DruidJS/blob/dcefb767556f3c4cf43bdeb36d2750ae8d5ef93c/src/dimred/SMACOF.js#L35)
...
> **parameter**(): [`ParametersSMACOF`](../interfaces/ParametersSMACOF.md)
...
[`ParametersSMACOF`](../interfaces/ParametersSMACOF.md)
...
> **parameter**\<`K`\>(`name`): [`ParametersSMACOF`](../interfaces/ParametersSMACOF.md)\[`K`\]
...
`K` *extends* keyof [`ParametersSMACOF`](../interfaces/ParametersSMACOF.md)
...
[`ParametersSMACOF`](../interfaces/ParametersSMACOF.md)\[`K`\]
...
> **parameter**\<`K`\>(`name`, `value`): `SMACOF`\<`T`\>
...
Defined in: [dimred/SMACOF.js:122](https://github.com/saehm/DruidJS/blob/dcefb767556f3c4cf43bdeb36d2750ae8d5ef93c/src/dimred/SMACOF.js#L122)
...
Defined in: [dimred/SMACOF.js:148](https://github.com/saehm/DruidJS/blob/dcefb767556f3c4cf43bdeb36d2750ae8d5ef93c/src/dimred/SMACOF.js#L148)
...
Defined in: [dimred/SMACOF.js:137](https://github.com/saehm/DruidJS/blob/dcefb767556f3c4cf43bdeb36d2750ae8d5ef93c/src/dimred/SMACOF.js#L137)
...
Defined in: [dimred/SMACOF.js:160](https://github.com/saehm/DruidJS/blob/dcefb767556f3c4cf43bdeb36d2750ae8d5ef93c/src/dimred/SMACOF.js#L160)
