[@saehrimnir/druidjs](../globals.md) / MDS
...
[PCA](PCA.md) for another linear alternative
...
`Partial`\<[`ParametersMDS`](../interfaces/ParametersMDS.md)\> = `{}`
...
`DR`\<`T`, [`ParametersMDS`](../interfaces/ParametersMDS.md)\>
...
[`ParametersMDS`](../interfaces/ParametersMDS.md)\[`K`\]
